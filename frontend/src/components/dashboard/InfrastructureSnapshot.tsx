...
export function InfrastructureSnapshot({ result }: Props) {
  ...
  return (
    <div className="rounded-xl border border-slate-800/90 bg-slate-950/40 px-4 py-3 ring-1 ring-white/[0.03]">
